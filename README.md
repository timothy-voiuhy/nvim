...
3. Don't forget to back up the old config. 
   ```
   git clone https://github.com/timothy-voiuhy/nvim ~/.config/nvim
   ```
4. Start Neovim and let it install plugins automatically:
   ```
   nvim
   ```
